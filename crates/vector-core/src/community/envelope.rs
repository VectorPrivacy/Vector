...
pub fn seal_with_signed_inner(
    ...
    // presence + cooperative kick) may be sealed. Rekey (3303) and InviteBundle (3304) have their own
    // carriers, so the contiguous 3300..=3302 range is admitted alongside the explicit 3305/3306/3309.
