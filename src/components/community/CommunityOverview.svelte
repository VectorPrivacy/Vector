    ...
    <div style="margin-top: 40px; width: 90%; margin-left: auto; margin-right: auto;">
        ...
        {#if ov.migration}
            ...
            <div id="group-migrate-row" style="display: flex; justify-content: center; margin-bottom: 10px;">
                <button id="group-migrate-btn" class="btn accept-btn btn-bounce" style="background-color: transparent; display: flex; align-items: center; gap: 6px; margin: 0 auto;"
                    ...
                    <span id="group-migrate-label" style="color: white;">{upgrading ? 'Upgrading...' : migrationLabel}</span>
                </button>
            </div>
        {/if}
