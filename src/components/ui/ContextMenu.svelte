...
<div class="context-menu" role="menu" class:is-visible={m.open} style:left="{m.x}px" style:top="{m.y}px"
     use:bindRoot onmousedown={(e) => e.stopPropagation()}>
    {#each m.items as item, i (i)}
        {#if item.divider}
            <div class="context-menu-divider"></div>
        {:else}
            <div class="context-menu-item" class:is-danger={item.danger} role="menuitem"
